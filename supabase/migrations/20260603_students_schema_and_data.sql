...
ALTER TABLE public.students
  ...
  ADD COLUMN IF NOT EXISTS school_section VARCHAR(50) CHECK (school_section IN ('creche', 'nursery', 'primary')),
  ADD COLUMN IF NOT EXISTS admission_number VARCHAR(100),
  ADD COLUMN IF NOT EXISTS student_id VARCHAR(100),
  ADD COLUMN IF NOT EXISTS avatar_url TEXT;

-- Clear existing and insert all students from official list
...
-- Enable RLS policies for new columns (students table should already have RLS)
